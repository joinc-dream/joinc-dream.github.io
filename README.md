...
로컬에서 포스트가 만족스럽게 보인다면, 변경사항을 GitHub 저장소에 업로드합니다.
...
3.  **푸시(Push)**
    ...
    ```
    (기본 브랜치가 `main`이 아닌 경우 해당 브랜치 이름으로 변경)

푸시가 완료되면 잠시 후 GitHub Pages에 자동으로 배포되어 블로그에 새로운 글이 나타납니다.
